...
const Navbar = () => {
  return (
    <div className="flex justify-between font-bold m-10 text-lg font-martian animate-fadeInGrow">
      ...
      <ul className="flex gap-10">
        <li>
          <a href="#main" className='hover:underline relative before:content-[""] before:block before:absolute before:w-0/100 before:h-[2px] before:bg-black before:bottom-0 before:left-0 hover:before:w-100/100 transition-width duration-300'>Home</a>
        </li>
        <li>
